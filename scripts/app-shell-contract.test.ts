...
assert.match(dashboard, /Dashboard บริหารสัญญา/)
...
assert.match(css, /\.pdf-document-viewer__loading span[\s\S]*linear-gradient/, 'the PDF loading shimmer is intentionally scoped to the document viewer')
