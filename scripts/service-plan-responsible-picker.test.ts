...
assert.doesNotMatch(detail, /ServicePlanResponsibleDialog/, 'plan detail must not show responsible assignment')
assert.doesNotMatch(detail, /listServiceCommitteeCandidates/, 'plan detail must not load responsible candidates for managers')
