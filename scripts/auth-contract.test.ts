...
assert.match(login, /ระบบบริหารคลัง<br \/><span className="login-bench-panel__title-line">พัสดุและสัญญา<\/span>/, 'the login title must identify inventory and contract management')
