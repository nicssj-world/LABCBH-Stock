...
assert.match(fulfillerNameSql, /add column if not exists fulfilled_by_name text/i)
assert.match(fulfillerNameSql, /update public\.requisitions[\s\S]*from public\.profiles/i)
