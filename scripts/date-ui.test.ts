...
import { addIsoDays, bangkokIsoDate, formatThaiDateFull, formatThaiDateInput, formatThaiDateLong, formatThaiDateTimeFull, parseThaiDateInput } from '../lib/date/thai'

assert.equal(formatThaiDateInput('2026-08-02'), '02/08/2569')
assert.equal(formatThaiDateLong('2025-10-01'), '01 ตุลาคม 2568')
assert.equal(formatThaiDateFull('2026-10-01'), '1 ตุลาคม 2569')
assert.match(formatThaiDateTimeFull('2026-10-01T09:05:00.000Z'), /^1 ตุลาคม 2569 /)
