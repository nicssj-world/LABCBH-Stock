...
assert.equal(message.altText, 'PO PO-2569-0001 สำหรับ PR PR-2569-0001')
assert.match(serializedMessage, /PR-2569-0001/)
assert.match(serializedMessage, /พร้อมดำเนินการ/)
assert.doesNotMatch(serializedMessage, /มีเอกสาร PO/)
