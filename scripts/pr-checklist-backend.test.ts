...
assert.match(presignRoute, /methodRequiresAnnualPlanReference/, 'users must not presign a manual plan-page upload for plan-backed PRs')
...
assert.match(checklistServer, /generated_by_system/, 'the server must accept plan-page uploads only when generated by the annual-plan action')
