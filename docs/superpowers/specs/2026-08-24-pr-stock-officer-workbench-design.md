...
1. **ตรวจเอกสารและกรรมการ** — toolbar ภาษาไทย, เรียงไฟล์หลักก่อนใบเสนอราคา, และมีหัวข้อกลุ่มกรรมการที่ชัดเจน โดยใช้ flat lane + accent line แทนกรอบ card ซ้อน
...
- เปลี่ยนข้อความปุ่มดาวน์โหลดใน checklist เป็นภาษาไทย (`ดาวน์โหลดทั้งหมด`) และเปลี่ยนการสร้าง PDF กรรมการเป็นปุ่ม `เปิดดู PDF กรรมการ` ที่เปิดเอกสารใน preview dialog หน้าเดิม
- ไม่แสดงตัวนับรวมแบบ `N ไฟล์ · N รายชื่อ` ในแถบหัวข้อ STOCK OFFICER; ให้จำนวนอยู่กับหัวข้อกลุ่มที่เกี่ยวข้องแทน และใช้ปุ่มพื้นเข้ม contrast สูงสำหรับ `เปิดดู` รายไฟล์
- endpoint ของ PDF กรรมการใช้ `Content-Disposition: inline` เพื่อให้ browser เปิดดูแทนการบังคับดาวน์โหลด
