...
import { serviceCreditNoteSourceOptions } from '@/lib/service-procurement/domain'
...
import { ServiceBarcodeScanner } from './ServiceBarcodeScanner'

interface Props {
  request: Pick<ServicePurchaseRequestRecord, 'isRedCross' | 'usageEvents'>
  idPrefix: string
  ...
  disabled?: boolean
  onDocumentTypeChange: (value: ServiceExpenseDocumentType) => void
...
export function ServiceExpenseDocumentFields({
  request,
  idPrefix,
  documentType,
  sourceExpenseId,
  ...
  return (
    <>
      {request.isRedCross && (
        <div className="service-expense-document-toggle form-grid__wide">
          <label className="service-expense-document-toggle__control">
            <input
              type="checkbox"
      ...
      {documentType === 'credit_note' && (
        <label id={`${idPrefix}-credit-fields`} className="service-expense-document-source">
      ...
      <label className="service-expense-document-number">
        ...
        <div className="service-expense-document-number__control">
          <input
            ref={invoiceInputRef}
            id={`${idPrefix}-invoice`}
            value={invoiceNumber}
          ...
          <Button
            type="button"
            variant="secondary"
            className="service-expense-document-number__scan"
            disabled={disabled}
