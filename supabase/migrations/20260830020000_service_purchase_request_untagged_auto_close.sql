...
-- Untagged service PRs follow the same immediate-close workflow as
-- contract-backed service PRs. Red Cross-only plans remain open because they
-- support multiple daily expense entries and invoice-summary exports.
...
begin
  ...
  -- Contract-backed and untagged plans close immediately after the expense is
  -- recorded. The close RPC also posts the plan expense and releases any
  -- reservation. Red Cross-only plans intentionally stay open.
